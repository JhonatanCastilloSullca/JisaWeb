...
const StickyReserva = () => {
    return (
        <div className="w-full mx-auto bg-gray-50 sticky bottom-0">
            <div className="w-full max-w-7xl mx-auto flex justify-between px-7  py-3">
                <div className="precios-reserva flex flex-col">
                    ...
                    <div className="flex gap-x-2">
                        ...
                        <span className="font-bold text-2xl text-JisaCyan/50 line-through">1099.00:</span>
                    </div>
                ...
                <div className="botones-precios-reserva flex gap-x-4 justify-center items-center">
                    <a href="#" className="px-4 py-2 bg-JisaGris text-white font-semibold text-xl rounded-md ">RESERVAR AHORA</a>
                    <a href="#" className="px-4 py-2 bg-JisaCyan text-white font-semibold text-xl rounded-md">ASESOR ONLINE</a>
                </div>
            </div>
        </div>)
}
