        ...
        <div className="w-full max-w-7xl mx-auto -mt-12 z-30 relative">
            <div className="container mx-auto py-4">
                <form className="group relative">
                    ...
                    <input className="bg-white h-16 focus:ring-2 focus:ring-JisaCyan focus:outline-none appearance-none w-full text-xl leading-6 text-JisaGris/80 placeholder-JisaGris/30 rounded-lg pl-10 pr-4   truncate shadow-xl" type="text" aria-label="Filter projects" placeholder="Machu Picchu: Fullday en Tren Turístico Expedition..." />
                </form>
            </div>
        </div>
    )
