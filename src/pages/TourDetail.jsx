            ...
            <div className="w-full max-w-7xl mx-auto mt-24 mb-12">
                <div className="grid grid-cols-12 gap-4">
                    <div className="md:col-span-6 col-span-12 h-auto flex flex-col md:items-start items-center justify-center align-middle px-10">
                        ...
                        <div className="flex text-JisaCyan gap-x-2" >
                            <MapDotIcon />
                            <a href="#" className="font-semibold">Cusco</a>
                            <span className="font-black">-</span>
                            <a href="#" className="font-semibold">Machupicchu</a>
                            <span className="font-black">-</span>
                            <a href="#" className="font-semibold">Valle Sagrado</a>
                        </div>
                        <ParrafoContent
